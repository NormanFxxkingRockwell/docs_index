...
| 功能 | 文档路径 |
|------|----------|
| Notification Kit简介 | [Notification Kit简介](../../docs/zh-cn/application-dev/notification/notification-overview.md) |
| 请求通知授权 | [请求通知授权](../../docs/zh-cn/application-dev/notification/notification-enable.md) |
| 管理通知渠道 | [管理通知渠道](../../docs/zh-cn/application-dev/notification/notification-slot.md) |
| 发布文本类型通知 | [发布文本类型通知](../../docs/zh-cn/application-dev/notification/text-notification.md) |
| 发布进度条类型通知 | [发布进度条类型通知](../../docs/zh-cn/application-dev/notification/progress-bar-notification.md) |
| 为通知添加行为意图 | [为通知添加行为意图](../../docs/zh-cn/application-dev/notification/notification-with-wantagent.md) |
| 更新通知 | [更新通知](../../docs/zh-cn/application-dev/notification/notification-update.md) |
| 取消通知 | [取消通知](../../docs/zh-cn/application-dev/notification/notification-cancel.md) |
| 管理通知角标 | [管理通知角标](../../docs/zh-cn/application-dev/notification/notification-badge.md) |
| 跨设备协同通知概述 | [跨设备协同通知概述](../../docs/zh-cn/application-dev/notification/notification-distributed-overview.md) |
| 清除跨设备场景下的重复通知 | [清除跨设备场景下的重复通知](../../docs/zh-cn/application-dev/notification/notification-distributed-messageid.md) |
| 通知消息跨设备协同管理 | [通知消息跨设备协同管理](../../docs/zh-cn/application-dev/notification/notification-distributed-notdistributed-sys.md) |
| 订阅通知（系统应用） | [订阅通知](../../docs/zh-cn/application-dev/notification/notification-subscription-sys.md) |
| NotificationSubscriberExtensionAbility概述 | [NotificationSubscriberExtensionAbility (开发概述)](../../docs/zh-cn/application-dev/notification/notification-subscriber-extension-ability.md) |
| 通知订阅扩展能力开发步骤 | [通知订阅扩展能力开发步骤](../../docs/zh-cn/application-dev/notification/notification-subscriber-extension-ability-development-steps.md) |
| 发布实况窗类型通知（系统应用） | [发布实况窗类型通知](../../docs/zh-cn/application-dev/notification/live-view-notification-sys.md) |
